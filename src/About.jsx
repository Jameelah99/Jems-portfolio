       ...
       <section className="stack-section" id="staack">
          ...
          <section className="stack-group">
            <div className="stack-progress-wrapper" id="stack3">
              ...
              <progress id="html-progress" className="stack-progress" value="90" max="100">90%</progress>
            </div>
      
            <div className="stack-progress-wrapper" id="stack4" >
              <label for="html-progress" className="stack-title"> CSS:</label>
              <progress id="css-progress" className="stack-progress" value="90" max="100">90%</progress>
            </div>
      
            <div className="stack-progress-wrapper" id="stack1" >
              <label for="html-progress" className="stack-title"> JAVASCRIPT:</label>
              <progress id="html-progress" className="stack-progress" value="60" max="100">90%</progress>
            </div>
      
            <div className="stack-progress-wrapper" id="stack2">
              <label for="html-progress" className="stack-title"> REACTJS:</label>
              <progress id="html-progress" className="stack-progress" value="70" max="100">90%</progress>
            </div>
          </section>
        </section>
